...
After viewing the week 9 lecture on command line arguments I returned to this solution and added the sys.argv function within the sys module. Sys.argv will print the name of this file to the screen when the user enters an argument on the command line. It will also print the full list of commands that were entered on the command line. 
