...
for i in range (1000, 10000):        # I have defined the range as being between the numbers 1,000 and 10,000
    if (i % 6 == 0) and (i % 12 != 0):  # I have used an if statement to capture if the number is divisible by 6 and also not divisible by 12 
